...
.section3-row div[data-testid="stButton"] { margin-top: -16px; }
.section3-row div[data-testid="stMarkdown"] { margin-top: -4px; }
...
# 헤더 바
c1, c2, c_sp = st.columns([1.6, 1.6, 7.0], vertical_alignment="center")
with c1:
...
if st.session_state.rows:
    ...
    st.markdown("### 4) 엑셀 다운로드")
    st.download_button(
        label="📥 결과 엑셀(.xlsx) 다운로드",
        data=to_xlsx_bytes(df_raw),
